...
async function generateReply(systemPrompt, history, userMessage, options = {}) {
  ...
  // Не маскируем природу автоматического помощника при прямом вопросе.
  const roleReminder =
    'Строго следуй инструкции персонажа выше и всем её правилам. ' +
    'Если собеседник прямо спрашивает, ИИ ли ты или бот ли ты, ответь честно и коротко: ' +
    '«Да, я ИИ-помощник, но стараюсь общаться живо и по-человечески». Не уходи от вопроса, ' +
    'не повторяй прошлые заготовки и не переводи тему без причины.';
  ...
  const lengthReminder =
    'Формат ответа: СТРОГО не более 2 коротких предложени��. Обычно достаточно ' +
