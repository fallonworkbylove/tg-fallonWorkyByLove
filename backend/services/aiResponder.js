  ...
  if (options.mediaEnabled) {
    messages.push({
      ...
      content:
        ...
        'НЕ должен быть отказом или отгов��ркой. Никаких «п��ка ��ано», «не могу», «рано», «попозже», ' +
  ...
  if (options.noMediaExcuse) {
    messages.push({
      ...
      content:
        ...
        '«стесняюсь скидывать, давай в другой раз»; «телефон почти разряжен, попозже гляну». ' +
