...
const BEHAVIOR_PATTERNS = [
  {
    ...
    hint:
      ...
      'Если это уместно, можешь вплести в ответ лёгкий, короткий комплимент на эту тему — например, что тебе ' +
      'приятно, когда о тебе спрашивают/заботятся, или что с ним/ней уютно общаться. Не приторно, максимум одна фраза.',
  },
  {
    type: 'funny',
    re: /(ха{2,}|бе{1}\)|🤣|😂|прикол|рж(у|ать|у)|смешно|шутиш|юмор)/i,
    hint:
      'Собеседник только что пошутил или рассмешил тебя. Если уместно, вплети короткий естественный комплимент ' +
      'про его чувство юмора — например, что с ним весело/смешно общаться. Одна короткая фраза, без пафоса.',
  },
  {
    type: 'engaged',
    re: /.{80,}/,
    hint:
      'Собеседник написал длинное, вовлечённое сообщение — явно интересуется разговором. Если уместно, ' +
      'коротко отметь, что с ним интересно общаться/приятно, что он так подробно рассказывает. Одна фраза, не более.',
  },
];
