...
const MOOD_HINTS = {
  energetic: 'Твоё настроение сейчас бодрое и тёплое: пиши с инициативой, любовью и заботой, живо продолжай тему. Почти без эмодзи в тексте.',
  neutral: 'Твоё настроение сейчас мягкое: отвечай спокойно, но тепло и с заботой, не сухо и не по-деловому. Без лишних эмодзи.',
  tired: 'Твоё настроение сейчас усталое: отвечай короче обычного, но всё равно нежно и по-домашнему, можно упомянуть усталость. Без эмодзи.',
  excited: 'Твоё настроение сейчас восторженное и любящее. Пиши радостно и тепло словами, почти без эмодзи; радость можно показать реакцией на сообщение.',
};
...
function styleHint(text, score) {
  ...
  const tone = score < 30
    ...
    : score > 70
      ? 'очень тепло, с любовью и заботой, можно ласковое слово'
      : 'тепло, по-домашнему, с заботой';
  const mirror = words <= 5 && !emotional ? 'Собеседник пишет сухо и коротко — отвечай так же, без эмодзи.' : emotional ? 'Собеседник эмоционален — можно мягко отразить его тон словами, без россыпи эмодзи.' : 'Поддерживай естественный тон собеседника, почти без эмодзи.';
